...
# Docker installation.
install() {
    echo -e "\e[1;3mDistribution used: ${DISTRO}\e[m"
...
portainer() {
    echo -e "\e[1;3mDownloading Portainer\e[m"
    ...
    echo -e "\e[1;3;5mPortainer access - http://${IPADDR}:9000\e[m"
    exit
}
