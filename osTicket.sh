...
config() {
    echo -e "\e[1;3mConfiguring Apache\e[m"
...
# Database creation.
database() {
    echo -e "\e[1;3mConfiguring MySQL\e[m"
...
osticket() {
    echo -e "\e[1;3mDownloading osTicket\e[m"
...
service() {
    ...
    echo -e "\e[1;3;5mFinished, configure webUI - http://${IPADDR}/setup/install.php\e[m"
    exit
}
